 ...
 * @author p-v
 */
public class CellView2 extends BaseCellView {
        ...
        public CellView2(Context context, AttributeSet attrs) {
            super(context, attrs);
            init();
        }

        public CellView2(Context context, AttributeSet attrs, int defStyleAttr) {
